  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav ms-auto">
        ...
        <li class="nav-item">
          <a class="nav-link active" href="#">Approval Status</a>
        </li>
        <li class="nav-item">
          <a class="nav-link active" href="subjects.php?email=<?php echo htmlspecialchars($email); ?>">Subjects</a>
        </li>
        <li class="nav-item">
    ...
    <table class="table table-bordered mt-4">
        ...
        <tbody>
            <tr>
                ...
                <td><?php echo $denyData['denied_date']; ?></td>
            </tr>
        </tbody>
    </table>
    <?php else: ?>
    <!-- Message for No Status Found -->
    <div class="alert alert-warning mt-4" role="alert">
        No approval or denial record found for the email: <?php echo htmlspecialchars($email); ?>
    </div>
    <?php endif; ?>
